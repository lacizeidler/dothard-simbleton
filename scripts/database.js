const businesses = [
  ...
  const businessesInNY = (businessObject) => {
  ...
  export const nyBusinesses = () => {
      const filteredBusinesses = businesses.filter( businessesInNY )
      return filteredBusinesses
  }

  const businessesInManufacturing = (businessObject) => {
...
export const manufacturingBusinesses = () => {
    const filteredBusinessesInManufacturing = businesses.filter(businessesInManufacturing)
    return filteredBusinessesInManufacturing
}

export const getAgents = () => {
        const copyOfAgents = businesses.map(item => ({...item}))
        return copyOfAgents
}
